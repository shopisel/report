...
A abordagem adoptada não substituiu o raciocínio crítico nem as decisões de engenharia: tratou-se de um trabalho em conjunto com a IA, em que os autores mantiveram o controlo sobre as escolhas arquitecturais, a conformidade com os requisitos funcionais, a execução de testes e a verificação do comportamento do sistema em ambiente real. O objectivo foi aumentar a produtividade sem comprometer a fiabilidade da solução desenvolvida.
