...
Por uma questão de foco, a Figura~\ref{fig:pipeline} representa apenas os componentes de execução e o fluxo de dados entre eles. O mecanismo que desencadeia cada etapa — workflows de GitHub Actions que invocam os scrapers e, de seguida, o MatchQueue Service e o FCM Notification Worker através de eventos \texttt{repository\_dispatch} — não é um componente de runtime e não está representado no diagrama; a orquestração completa é descrita na Secção~\ref{sec:5.4}.
