...
O \textbf{CompraBem} é uma plataforma portuguesa que permite comparar preços de produtos em múltiplos supermercados, incluindo Continente, Pingo Doce e Auchan. Apresenta o preço atual e o histórico de variações, sendo útil para planeamento de compras. Contudo, a plataforma não oferece funcionalidades de gestão de listas de compras, leitura de código de barras ou notificações de descida de preço, sendo mais uma ferramenta de consulta pontual do que de acompanhamento contínuo~\cite{comprabem}.
...
\hline
\textbf{Funcionalidade} & \textbf{Bring!} & \textbf{CompraBem} & \textbf{Kuanto Kusta} & \textbf{Continente} & \textbf{Flipp} & \textbf{ShopISEL} \\
\hline
Gestão de listas        & \checkmark & --         & --         & \checkmark & \checkmark & \checkmark \\
\hline
Comparação de preços    & --         & \checkmark & \checkmark & --         & \checkmark & \checkmark \\
\hline
Múltiplas insígnias     & --         & \checkmark & \checkmark & --         & \checkmark & \checkmark \\
\hline
...
\hline
Aplicação web           & --         & \checkmark & \checkmark & \checkmark & --         & \checkmark \\
\hline
