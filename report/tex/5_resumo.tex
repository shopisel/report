...
Em suma, este trabalho demonstra como uma aplicação com um âmbito funcional inicial delimitado pode evoluir para um protótipo funcional avançado, com uma base extensível para novas funcionalidades, abordando desafios relacionados com sistemas distribuídos, gestão de dados e interação em tempo real com o utilizador.
