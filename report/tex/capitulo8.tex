...
\begin{itemize}
    ...
    \item Um serviço ASP.NET Core com modo \textit{worker} (MatchQueue), executado pelo GitHub Actions, que faz a ponte entre dados de scraping armazenados em MongoDB e a base de dados relacional normalizada;
...
O projeto ShopISEL demonstra a viabilidade de uma plataforma digital funcional e coerente, mas também evidencia limites concretos do processo seguido. Contribuíram para essa viabilidade a decomposição por serviços, contratos explícitos entre componentes, contentorização, \ac{CI/CD}, testes de integração e revisão iterativa das funcionalidades, o que ajudou a manter o sistema evolutivo e verificável.
