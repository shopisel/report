...
\begin{itemize}
    ...
    \item Uma aplicação web em React com TypeScript e Vite, com suporte a concorrência optimista nas listas de compras e arquitectura white-label dinâmica injectada em tempo de \textit{build};
    ...
    \item Mecanismos de concorrência optimista e tratamento centralizado de erros no List Service, com adaptação correspondente nas aplicações cliente;
