...
\begin{itemize}
    ...
    \item Um repositório \texttt{custom-label} com os workflows e configurações necessários para produzir e publicar variantes white label da aplicação móvel, sem alteração ao código-fonte partilhado.
\end{itemize}
...
\textbf{Desenvolvimento White Label.} A arquitetura modular da plataforma e a capacidade de customização das aplicações cliente através de pipelines de \ac{CI/CD} dedicadas abre a possibilidade de oferecer o sistema como plataforma white label, adaptável a diferentes contextos de retalho ou parceiros comerciais. A base para este modelo está já implementada no repositório \texttt{custom-label}, que demonstra a viabilidade da abordagem e serve de ponto de partida para variantes futuras.
