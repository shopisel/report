...
\begin{enumerate}
    ...
    \item Despoleta, através de um evento \texttt{repository\_dispatch}, o workflow do MatchQueue, que executa o componente worker para normalizar os dados recolhidos.
\end{enumerate}
